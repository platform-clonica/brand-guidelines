  ...
  return (
    <SectionShell id="universo-visual" title={t('title')} variant="dark">
      ...
      <div className="grid grid-cols-12 gap-3 sm:gap-4">
        ...
        <img loading="lazy" decoding="async" src="/universo/universo-01.jpg" alt="" aria-hidden
             className="col-span-6 lg:col-span-5 aspect-[3/4] object-cover w-full h-full" />
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img loading="lazy" decoding="async" src="/universo/universo-02.jpg" alt="" aria-hidden
             className="col-span-6 lg:col-span-7 aspect-[3/2] object-cover w-full h-full" />
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img loading="lazy" decoding="async" src="/universo/universo-03.jpg" alt="" aria-hidden
             className="col-span-6 lg:col-span-7 aspect-[16/10] object-cover w-full h-full" />
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img loading="lazy" decoding="async" src="/universo/universo-04.jpg" alt="" aria-hidden
             className="col-span-6 lg:col-span-5 aspect-[3/4] object-cover w-full h-full" />
      </div>
    </SectionShell>
  );
