    ...
    <div style={{ minHeight: '100vh', background: colors.warmLight, color: colors.dark }}>
      ...
      <div style={{ maxWidth: 1120, margin: '0 auto', padding: '32px 32px 64px' }}>
        <div
          style={{
            display: 'grid',
            // auto-fit + minmax colapsa a una columna en pantallas estrechas, sin media queries.
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <section style={panel}>
              <label style={labelStyle} htmlFor="rw-context">Contexto y destinatario</label>
              <textarea
                id="rw-context"
                value={context}
            ...
            <button
              ...
              style={{
                ...btn, padding: '13px 16px', font: `500 12px/1 ${MONO}`, letterSpacing: '.06em',
          ...
          {/* ── Resultado ── */}
          <section style={{ ...panel, minHeight: 420, display: 'flex', flexDirection: 'column' }}>
